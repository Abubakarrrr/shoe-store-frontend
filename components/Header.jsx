...
import { BiMenuAltRight, BiWon } from "react-icons/bi";
...
const Header = () => {
    ...
    return (
        <header className={`bg-white w-full h-[50px] md:h-[80px]  flex items-center justify-between z-20 sticky top-0 transition-transform duration-300 ${show}`}>
